<!-- Sidebar -->
<div class="sidebar" id="mySidebar" style="background-color: #171616;" >
<div class="side-header" >
    <img src="logo.png" class ="text-centre: rounded-circle w-75" style="background-color: #ffc226"  alt="Pet Talks logo"> 
    <h5 style="margin-top:10px;">Welcome</h5>
</div>
...
<div id="main">
    <button class="openbtn" onclick="openNav()" style="background-color: #171616;"><i class="fa fa-home"></i></button>
</div>
