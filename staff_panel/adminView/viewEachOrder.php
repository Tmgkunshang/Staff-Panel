...
<table class="table table-striped">
    <thead>
        <tr>
            <th style="background-color: #ffc226; color:black; height:40px">S.N.</th>
            <th style="background-color: #ffc226; color:black; height:40px">Product Image</th>
            <th style="background-color: #ffc226; color:black; height:40px">Product Name</th>
            <th style="background-color: #ffc226; color:black; height:40px">Size</th>
            <th style="background-color: #ffc226; color:black; height:40px">Quantity</th>
            <th style="background-color: #ffc226; color:black; height:40px">Unit Price</th>
        </tr>
    </thead>
    <?php
